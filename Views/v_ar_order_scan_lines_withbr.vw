DROP VIEW DSS.V_AR_ORDER_SCAN_LINES_WITHBR;

CREATE OR REPLACE FORCE VIEW DSS.V_AR_ORDER_SCAN_LINES_WITHBR
(
    JOBID
   ,LINEID
   ,MERGED
...
AS
    SELECT LIN.JOBID
          ...
          ,WS.WARRANTY_CATG_FLAG
               WARRANTYGROUP
    FROM AR_ORDER_SCAN_LINES LIN
         LEFT OUTER JOIN AR_ORDER_SCAN_HEADER HD ON LIN.JOBID = HD.JOBID
...
GRANT SELECT ON DSS.V_AR_ORDER_SCAN_LINES_WITHBR TO SELDATA;
