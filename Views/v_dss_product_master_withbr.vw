DROP VIEW DSS.V_DSS_PRODUCT_MASTER_WITHBR;

CREATE OR REPLACE FORCE VIEW DSS.V_DSS_PRODUCT_MASTER_WITHBR
(
    LINEID
   ,OPERATING_UNIT
   ,ORGANIZATION_ID
...
GRANT SELECT ON DSS.V_DSS_PRODUCT_MASTER_WITHBR TO SELDATA;
