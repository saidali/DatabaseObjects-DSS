DROP PACKAGE DSS.PKG_INF_BRANDS_INFO;

CREATE OR REPLACE PACKAGE DSS.PKG_INF_BRANDS_INFO
AS
   PROCEDURE INF_START;
END PKG_INF_BRANDS_INFO;
/


DROP PACKAGE BODY DSS.PKG_INF_BRANDS_INFO;

CREATE OR REPLACE PACKAGE BODY DSS.PKG_INF_BRANDS_INFO
AS
   ...
   BEGIN
      ...
      INSERT INTO DSS_BRAND_INFO (SETID,
         ...
         SELECT FLEX_VALUE_SET_ID,
          ...
          WHERE FLEX_VALUE_SET_ID = '1009637';
