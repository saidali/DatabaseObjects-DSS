DROP PACKAGE DSS.PKG_INF_SUB_CAT_INFO;

CREATE OR REPLACE PACKAGE DSS.PKG_INF_SUB_CAT_INFO
AS
   PROCEDURE INF_START;
END PKG_INF_SUB_CAT_INFO;
/


DROP PACKAGE BODY DSS.PKG_INF_SUB_CAT_INFO;

CREATE OR REPLACE PACKAGE BODY DSS.PKG_INF_SUB_CAT_INFO
AS
