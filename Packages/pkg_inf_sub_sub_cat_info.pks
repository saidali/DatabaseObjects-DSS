DROP PACKAGE DSS.PKG_INF_SUB_SUB_CAT_INFO;

CREATE OR REPLACE PACKAGE DSS.PKG_INF_SUB_SUB_CAT_INFO
AS
   PROCEDURE INF_START;
END PKG_INF_SUB_SUB_CAT_INFO;
/


DROP PACKAGE BODY DSS.PKG_INF_SUB_SUB_CAT_INFO;

CREATE OR REPLACE PACKAGE BODY DSS.PKG_INF_SUB_SUB_CAT_INFO
AS
   ...
   BEGIN
      ...
      INSERT INTO DSS_SUB_SUB_CATEGORY_INFO (SETID,
         ...
         SELECT FLEX_VALUE_SET_ID,
          ...
          WHERE FLEX_VALUE_SET_ID = '1009640';
